...
function runTheRegister() {
  ...
  try {
    // Verify that the value of the change is not greater than or equal to zero
    // If that condition is true, an error message is thrown
    ...
    // Set the innerHTML of the element with the id 'warning' to the error message
